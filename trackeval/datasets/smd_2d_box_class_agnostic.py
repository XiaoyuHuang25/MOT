...
class SMD2DBoxClassAgnostic(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            'BENCHMARK': 'SMD',  # Valid: 'SMDVIS', 'SMDNIR', 'SMDVISNIR'
    ...
    def __init__(self, config=None):
        ...
        # Get classes to eval
        self.valid_classes = ['Ferry', 'Buoy', 'Vessel/ship', 'Speed boat', 'Boat',
                              'Kayak', 'Sail boat', 'Flying bird/plane', 'Other']
