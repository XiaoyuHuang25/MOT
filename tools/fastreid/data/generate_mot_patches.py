...
def make_parser():
    ...
    parser.add_argument("--data_path", default="datasets", help="path to MOT data")
    parser.add_argument("--save_path", default="fast_reid/datasets/data", help="Path to save the MOT-ReID dataset")
