...
from trackers.mht_tracker.dataassociator import MHTDataAssociator
...
class Exp(BaseExp):
    def __init__(self):
        ...
        self.tracker_name = "MHTStoneSoup"
    ...
    def set_params(self):
        ...
        self.initiator = GaussianMixtureInitiator(self.initiator)
        ...
        self.hypothesiser = MHTHypothesiser(self.hypothesiser)

        self.data_associator = MurtySolver(
            hypothesiser=self.hypothesiser,
        )
        self.data_associator = MHTDataAssociator(
            self.hypothesiser,
            top_n_hypotheses=self.top_n_hypotheses,
            associator=self.data_associator
            )
